...
public class GruposVerListaMiemGrup extends javax.swing.JInternalFrame {

   
    public GruposVerListaMiemGrup() {
        initComponents();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
     ...
     public void CargarMiembros(){
        ...
        res = Herramientas.Utilidades.Consulta("Select M.* from Miembros M inner join GruposVsMiembros GM on M.CodMiembro= GM.CodMiembro where M.CodUsuario='" + Login.GetCodUsuario() + "' and GM.CodGrupo='" + LblGrupo.getText() + "'");
        try{
            while(res.next()){
                Vector v = new Vector();
                v.add(res.getInt(1));
    ...
    private void BtnEliminar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEliminar1ActionPerformed
        if(table2.getRowCount() != 0 && table2.getSelectedRow() != -1){
            ...
            if (JOptionPane.showConfirmDialog(rootPane, "¿Está seguro que desea quitar a este miembro?",
                "AVISO", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){

            String Codigo =String.valueOf(table2.getValueAt(table2.getSelectedRow(),0));
            try {

                Herramientas.Procedimientos.EliminarMiembroGrupo(LblGrupo.getText(),Codigo);

                JOptionPane.showMessageDialog(null,"Se ha quitado al miembro");
